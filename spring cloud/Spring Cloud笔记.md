...
## 0.1 创建依赖管理项目
### 0.1.1 ==创建一个工程名为 hello-spring-cloud-dependencies 的项目，pom.xml 配置文件如下==：
```xml
...
```
通过eureka.client.registerWithEureka:false 和 fetchRegistry:false 来表明自己是一个 Eureka Server.
### 操作界面
